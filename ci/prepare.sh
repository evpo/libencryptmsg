...
pushd $HOME/botan
    if [[ "$env_name" == "appveyor" ]]; then
        ./configure.py --cc gcc --cpu x86 --os mingw --amalgamation --disable-shared --with-zlib --with-bzip2 --enable-modules aes,pbkdf2,auto_rng,compression --extra-cxxflags -I C:\projects\encryptpad\deps\zlib -I C:\projects\encryptpad\deps\bzip2
